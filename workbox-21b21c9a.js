define("./workbox-21b21c9a.js", ["exports"], (function(t) {
    ...
    class R {
        constructor(t, e) {
            this.h = {}, Object.assign(this, e), this.event = e.event, this.u = t, this.l = new y, this.p = [], this.m = [...t.plugins], this.g = new Map;
        ...
        async getCacheKey(t, e) {
            if (!this.h[e]) {
                let s = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) s = g(await t({
                    mode: e,
                    request: s,
                    event: this.event,
                    params: this.params
    ...
    function O(t) {
        return "function" == typeof t ? k(t) : (t instanceof IDBTransaction && function(t) {
            ...
            L.set(t, e)
        }(t), e = t, (D || (D = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some((t => e instanceof t)) ? new Proxy(t, C) : t);
        var e
    }
    ...
    class F {
        constructor(t, e = {}) {
            this.C = !1, this.k = !1, this.O = e.maxEntries, this.T = e.maxAgeSeconds, this.B = e.matchOptions, this._ = t, this.P = new A(t)
        }
        async expireEntries() {
